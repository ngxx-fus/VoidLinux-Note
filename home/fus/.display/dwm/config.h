...
static const char *fonts[] = { "CodeNewRoman Nerd Font:size=10" };
...
static const Key keys[] = {
	...
	{ WINKEY|ShiftMask,             XK_p,      spawn,          {.v = dmenucmd } },
    ...
    { MODKEY|ShiftMask,             XK_f,       spawn,          SHCMD("/home/fus/.fus/prt_sc.sh --full") },
    { MODKEY|ShiftMask,             XK_w,       spawn,          SHCMD("/home/fus/.fus/prt_sc.sh --window") },
    { MODKEY|ShiftMask,             XK_s,       spawn,          SHCMD("/usr/bin/flameshot gui") },
    { WINKEY,                       XK_p,       spawn,          SHCMD("/home/fus/.fus/toggle_display.sh") },
    { WINKEY,                       XK_e,       spawn,          SHCMD("/usr/bin/nautilus") },
    { WINKEY,                       XK_l,       spawn,          SHCMD("/usr/local/bin/slock") },
    { WINKEY,                       XK_r,       spawn,          {.v = termcmd }},
    { Mod1Mask,                     XK_space,   spawn,          SHCMD("rofi -show combi") },
	{ WINKEY,                       XK_Escape,  focusstack,     {.i = +1 } },
    { WINKEY,                       XK_n,       setlayout,      {.v = &layouts[3]} },
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button1,        spawn,          SHCMD("alacritty -e btop")},
};
